...
document.getElementById("work-carousel").addEventListener('scroll', function (e) {
    
    console.log(parseInt( (document.getElementById("work-carousel").scrollTop) / window.innerHeight ) );
